        ...
        <div className="bg-[#F7F7F7] min-h-full flex flex-col p-[30px] gap-[20px]">
            <div className="flex flex-col gap-[20px]">
                ...
                <div className="flex justify-between gap-[21px]">
                    ...
                    {/* 일정 상세 레이아웃*/}
                    <div
                        className="flex flex-col gap-[30px] bg-white px-[41px] py-[32px] w-[35%] border border-[#DBDBDB] rounded-[8px]">
                        <div className="text-[16px] font-bold">DEVELOPER</div>
                        <div className="flex flex-col gap-[16px]">
                            <div className="text-[16px] font-semibold">1월 10일</div>
                            <div
                                className="flex gap-[70px] justify-between bg-white px-[24px] py-[18px] border border-[#DBDBDB] rounded-[8px]">
                                <div>
                                    <div className="text-[16px] font-semibold">정규 회의A</div>
                                    <div className="text-[13px] text-[#A6A6A6] font-medium">에너지공학과 302강의실</div>
                                </div>
                                <div>
