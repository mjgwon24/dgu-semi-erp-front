...
export default function SignUpUI({
    ...
    return (
        <div className="flex w-full h-screen justify-center items-center" style={{color: "#F7F7F7"}}>
            <form className="flex flex-col items-center border rounded-2xl shadow-xl bg-[#FFFFFF] h-4/5 py-24 px-48 gap-12 w-2/5" onSubmit={handleSubmit}>
                <div className="flex flex-col items-center gap-1">
                    ...
                    <label className="text-xl pt-2" style={{color: "#3C3C3C"}}>동아리 행정을 보다 편리하게</label>
                </div>
                ...
                <div className="flex flex-col gap-2 w-full text-xl">
                    ...
                    <Checkbox className="text-lg font-bold text-[#3C3C3C]" checked={allChecked} onChange={onCheckAllChange}>전체 동의</Checkbox>
                    <Checkbox className="text-lg text-[#808080]" checked={checkedList.option1} onChange={onCheckChange} name="option1">19세 이상??</Checkbox>
                    <Checkbox className="text-lg text-[#808080]" checked={checkedList.option2} onChange={onCheckChange} name="option2">이용약관 동의</Checkbox>
                ...
                <div className="flex flex-col gap-2 w-full items-center">
                    <button className="bg-[#237BE6] rounded-lg w-full text-xl p-4" type="submit">회원가입</button>
