...
export default function SideBarLayout() {
    ...
    return (
        <div className="bg-[#212121] h-full flex flex-col p-6 text-white">
            ...
            <ul className="flex flex-col space-y-9 mt-8 pt-7">
                <li className="flex items-center space-x-3 text-white text-[16px] font-medium hover:text-blue-600 cursor-pointer">
                ...
                <li>
                    <div
                        ...
                        className="flex items-center space-x-3 text-white text-[16px] font-medium hover:text-blue-600 cursor-pointer"
                    >
                    ...
                    {isBudgetMenuOpen && (
                        <ul className="ml-4 mt-2 flex flex-col space-y-3">
                            <li className="text-gray-300 text-[14px] font-medium hover:text-blue-400 cursor-pointer">
                                예산 계획
                            </li>
                            <li className="text-gray-300 text-[14px] font-medium hover:text-blue-400 cursor-pointer">
                                예산 사용 내역
